...
//		id = getIntent().getExtras().getString("ids");
		getDetails(name);*/
//        new HttpAsyncTask().execute("http://b01.pumgrana.com/api/content/detail/".concat(id));
	}
	...
	public static class MainFragment extends Fragment {
        ...
        public void updateViewNoDB(View rootView) {
        	...
        	Log.d("fetchData", "req");
    		try {
    			req.execute("get", "http://" + "54.69.150.141" + "/api/content/detail/" + URLEncoder.encode(uri, "utf-8"));
    			...
    			for (int i=0; i < jObj.length(); i++) {
    				...
    				webview.loadData(((jObj.getJSONObject(i)).getString("body")), "text/html", null);
...
//    		        t2.setMovementMethod(new ScrollingMovementMethod());
    ...
    public void getTagsNoDB(String uri) {
		...
		try {
	        ...
	        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.tag_list, tagNameList);
    ...
    public void openHomeOnClick(View view)
    {
